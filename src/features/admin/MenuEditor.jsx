...
function MenuEditor() {
  ...
  const [formState, setFormState] = useState({ name: '', price: '', categoryId: '', description: '', imageUrl:'', promotionPrice: '' });
  ...
  const handleCancel = () => {
    setIsEditing(null);
    setFormState({ name: '', price: '', categoryId: '', description: '', imageUrl: '', promotionPrice: '' });
  };
                ...
                <div>
                  ...
                  {item.promotionPrice && item.promotionPrice > 0 ? (
                    <div className="flex items-center space-x-2">
                      ...
                      <p className="text-xs font-bold text-white bg-red-500 px-2 py-0.5 rounded-full">
